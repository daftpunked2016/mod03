<tr>
  ...
  <td>
	...
	<td>
      ...
      {
        //if($data->status_id != 1 && $pos != 13)
        if($data->status_id != 1 && $pos != 13 && $pos != 9 && $pos != 8){
...
<div id="rejectModal-<?php echo CHtml::encode($data->id); ?>" class="modal fade" role="dialog">
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-content">
      ...
      <form method="post" action="<?php echo Yii::app()->request->baseUrl; ?>/index.php/account/rejectreport?id=<?php echo CHtml::encode($data->id); ?>&st=a">
        <div class="modal-body">
