<tr>
  <td><?php echo CHtml::encode($data->rep_id); ?></td>
	...
	<td>
      ...
      {
        echo CHtml::link('<span class="fa fa-check" style="margin-right:3px;"></span>',array('/account/approvereport', 'id' => $data->id, 'st'=>'c'), array('title' => 'Approve Report', 'confirm' => "Are you sure you want to Approve this report?", 'style'=>'margin-right:3px;'));
