...
<tr class='desc <?php if($scoring == null) echo "danger"; else { if($data->color === "BLUE") echo "info"; elseif($data->color === "GREEN") echo "success"; }; ?>'>
  ...
  <td>
	...
	<td>
     <?php if($scoring != null): ?>
        <a href="<?php echo Yii::app()->baseUrl; ?>/index.php/account/printreport/<?php echo $scoring->report->id; ?>" target="_blank">
    <?php endif; ?>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="<?php echo Yii::app()->baseUrl; ?>/index.php/account/printreport/<?php echo $scoring->report->id; ?>" target="_blank" class="btn btn-primary" style="margin-right:10px;"><i class="fa fa-print" style="margin-right:5px;"></i>Print Report</a>
