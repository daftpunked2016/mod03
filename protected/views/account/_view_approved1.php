<tr>
  ...
  <td>
	...
	<td>
      ...
      {
        echo CHtml::link('<span class="fa fa-remove" style="margin-right:3px;"></span>Reject', array('/account/rejectreport', 'id' => $data->id, 'st'=>'a'), array('class' => 'btn btn-danger btn-sm', 'confirm' => "Are you sure you want to Reject this report?", 'title' => 'Reject Report', 'style'=>'margin-right:3px;'));
		  }
    ?>
	</td>
</tr>
