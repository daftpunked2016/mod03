<tr>
	...
	<td>
      ...
      echo CHtml::link('<span class="fa fa-pencil" style="margin-right:3px;"></span>Edit & Resubmit', array('/account/viewreportpdf', 'id' => $data->id), array('class' => 'btn btn-primary btn-sm', 'title' => 'View Report', 'target'=>'_blank', 'style'=>'margin-right:3px;'));
			
      if($display_actions_status)
      {
        echo CHtml::link('<span class="fa fa-remove" style="margin-right:3px;"></span>Delete', array('/account/rejectreport', 'id' => $data->id, 'st'=>'r'), array('class' => 'btn btn-danger btn-sm', 'confirm' => "Are you sure you want to Reject this report?", 'title' => 'Reject Report', 'style'=>'margin-right:3px;'));
		  }
    ?>
	</td>
</tr>
