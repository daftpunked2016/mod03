  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="active treeview">
        <a href="#">
          <i class="fa fa-users"></i> <span>Manage Trainers</span> <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu">
          <li><?php echo CHtml::link('<i class="fa fa-angle-right"></i><span>Area Training Director</span>',array('default/trainers', 'type'=>2)) ?></li>
          <li><?php echo CHtml::link('<i class="fa fa-angle-right"></i><span>Regional Training Director</span>',array('default/trainers', 'type'=>3)) ?></li>
          <!-- <li><?php //echo CHtml::link('<i class="fa fa-angle-right"></i><span>Local Training Director</span>',array('default/trainers', 'type'=>4)) ?></li> -->
        </ul>
      </li>
      <li>
