...
<section class="content-header">
	...
	<h2 style="text-align:center; margin-top:5px;">
		...
		<small>
			<?php 
				if ($trainer->training_position_id == 2) {
					if($area >= 1 && $area <= 5)
						echo "AREA ".$area;
					else
						echo "NATIONAL";
				}elseif($trainer->training_position_id == 3) {
					echo $region->region;
				}else{
					echo "Ranking";
				}
...
<section class="content" style="padding:10px 30px;">
	...
	<!-- <div class="well" style="margin:20px 20px; display:none;" id="search-well">
		<div class="row">
			<form name="search" method="GET" action="<?php //echo Yii::app()->baseUrl; ?>/index.php/trainers/etrainingScorecard/ranking">
				<div class="col-md-6">
