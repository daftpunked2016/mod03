    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <p class='text-center'>
          ...
          <div class="pull-left">
            Uploaded by: <strong><?php echo User::model()->getCompleteName2($data->account_id); ?> (<?php echo Chapter::model()->getChapter($data->chapter_id); ?>)</strong>
          </div>
      ...
      <form method="post" action="<?php echo Yii::app()->request->baseUrl; ?>/index.php/admin/default/rejectreport/id/<?php echo CHtml::encode($data->id); ?>">
        <div class="modal-body">
          
            <label>Remarks:</label>
            <br>
            <textarea name="PeaReportsRemarks[remarks]" class="form-control" required="required" style="resize: none;" placeholder="Start here.." rows="5"></textarea>
