						  	...
						  	?>
										<tr class="subcat <?php echo $cat->cat_id; ?>">
											<td>
										  	...
										  	<td id="subcat">
										  		<a href="<?php echo Yii::app()->baseUrl;?>/index.php/admin/default/listdescscoring?<?php if($chapter_id != null) echo "chapter_id=".$chapter_id."&"; ?>sub_id=<?php echo $subcat->sub_id; ?>">
										  			<i><?php echo $subcat->SubCat; ?> </i>
										  		</a>
										  		<a href="<?php echo Yii::app()->baseUrl;?>/index.php/admin/default/listdescscoring?sub_id=<?php echo $subcat->sub_id; ?>" class="glass">
