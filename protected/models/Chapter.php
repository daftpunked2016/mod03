...
class Chapter extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('area_no, region_id', 'numerical', 'integerOnly'=>true),
			array('chapter', 'length', 'max'=>26),
	...
	public function relations()
	{
		...
		return array(
			...
			'peareports' => array(self::HAS_MANY, 'PeaReports', 'chapter_id'),
			'valid_peareports' => array(self::HAS_MANY, 'PeaReports', 'chapter_id', 'condition'=>'status_id = 1'),
		);
	}
